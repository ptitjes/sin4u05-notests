...
/**
 * Code adapted from <a href="https://stackoverflow.com/questions/32613619/how-to-make-a-timespinner-in-javafx">
 * How to make a TimeSpinner in JavaFX?</a>
 */
public class TimeSpinner extends Spinner<LocalTime> {
    ...
    enum Mode {
        ...
        MINUTES {
            @Override
            LocalTime increment(LocalTime time, int steps) {
                return time.plusMinutes(steps * 5);
            }
